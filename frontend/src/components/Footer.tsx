...
export default function Footer() {
  ...
  const logoSize = siteConfig?.logoSize ? Number(siteConfig.logoSize) * 0.6 : 60;
      ...
      <div className="container mx-auto px-4">
        <div className="grid gap-8 md:grid-cols-3">
          <div>
            ...
            <p className="mt-4 text-sm text-white/70">
              <a href="mailto:contact@aurasuites.info" className="hover:text-luxury-gold transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/70">
              <li>
                <a href="#apartments" className="hover:text-luxury-gold transition-colors">
                  Apartments
                </a>
              </li>
              <li>
                <a href="#art" className="hover:text-luxury-gold transition-colors">
                  Art Collection
                </a>
              </li>
              <li>
                <a href="#experience" className="hover:text-luxury-gold transition-colors">
                  Experience
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/70">
              <li>
                <Link to="/imprint" className="hover:text-luxury-gold transition-colors">
                  Imprint
                </Link>
              </li>
              <li>
                <Link to="/privacy-policy" className="hover:text-luxury-gold transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 border-t border-white/10 pt-8 text-center text-sm text-white/70">
          <p className="flex items-center justify-center gap-2">
            © 2025. Built with <Heart className="h-4 w-4 fill-luxury-gold text-luxury-gold" /> using{' '}
            <a 
