...
import { MapPin, Music, Utensils, Sparkles, ArrowRight } from 'lucide-react';
...
const experiences = [
  {
    ...
    description: 'In the heart of Palermo Hollywood, surrounded by culture and history.',
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:gap-8">
          {experiences.map((experience, index) => {
            ...
            return (
              <Card 
                key={index}
                className="group overflow-hidden border-luxury-gold/20 bg-white shadow-lg transition-all duration-300 hover:shadow-2xl"
              >
