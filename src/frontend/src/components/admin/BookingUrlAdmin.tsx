    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Set the URL where users will be directed when they click "Book Your
            Stay" or "Book Now" buttons
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Enter the full URL including https:// (e.g., https://booking.com,
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            This is how the booking button will behave
          </CardDescription>
        </CardHeader>
        <CardContent>
